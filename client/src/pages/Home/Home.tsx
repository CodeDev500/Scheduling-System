  ...
  return (
    <div>
      <div className="h-[calc(100vh-4rem)] relative">
        ...
        />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-row items-center justify-center gap-4 md:gap-0 px-4 md:px-0">
